...
signal puzzle_exit(puzzleLayer:CanvasLayer,clean:bool)
signal puzzle_enter(puzzleLayer:CanvasLayer)
signal on_transition_finished()
signal exit_zoom_item(zoomItemName:String)
...
signal BrokenPicture()
signal mapaMesa()
signal zoom_item_closed(zoomItemName:String)
signal play_credits()
